...
2. What's New?
~~~~~~~~~~~~~~~~~
The ability to save/load/compare player stats to file has finally been implemented.

Along with that, the layout has been slightly tweaked to match that of the Windows version.
